...
firebase.auth().onAuthStateChanged(async function(user){
  ...
  if (user) {
    ...
    document.querySelector('.sign-in-or-sign-out').innerHTML = `
      <h1 class="user-display text-white font-bold text-l px-2 py-4">Hi, ${user.displayName}. You logged in using: ${user.email}.</h1>
      <a href="#" button class="sign-out bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-2 rounded">Sign Out</a>
    `
